  ...
  return (
    <AnimatedSection id="education">
      <div className="max-w-4xl w-full mx-auto">
        <p className="font-mono text-sm text-accent mb-3">&gt; education</p>
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-12">Education</h2>
        <div className="space-y-12">
          {education.map((edu, index) => (
            <div key={index} className="group hover:bg-secondary/30 p-4 sm:p-6 rounded-sm transition-all duration-300 sm:-mx-6">
